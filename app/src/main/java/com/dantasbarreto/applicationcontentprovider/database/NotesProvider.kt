package com.dantasbarreto.applicationcontentprovider.database
...
import com.dantasbarreto.applicationcontentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.dantasbarreto.applicationcontentprovider.provider"
        val BASE_URI = Uri.parse("content://$AUTHORITY")
        val URI_NOTES = Uri.withAppendedPath(BASE_URI, "notes")

        //"content://com.dantasbarreto.applicationcontentprovider.provider/notes"
